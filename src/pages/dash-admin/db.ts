...
//   carteiraId  Int
//   transacaoId Int?
//   expires_at  DateTime? // ✅ data e hora em que a recarga expira
//   isExpired   Boolean    @default(false) // ✅ status de expiração
//   created_at  DateTime   @default(now())
//   carteira    Carteira   @relation(fields: [carteiraId], references: [id])
//   pacote      Pacotes    @relation(fields: [pacoteId], references: [id])

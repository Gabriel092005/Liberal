...
export function Notificacoes() {
        ...
        {[...Array(5)].map((_, i) => (
         <>
                 <div className="flex flex-col gap-2">
                    <Skeleton key={i} className="h-20 w-80 rounded-xl" />
  ...
  return (
    <motion.div
      className="w-full lg:relative lg:left-30 lg:top-24  max-w-md mx-auto bg-white dark:bg-neutral-900 relative right-[1rem] shadow-md rounded-2xl p-3 flex flex-col h-[90vh]"

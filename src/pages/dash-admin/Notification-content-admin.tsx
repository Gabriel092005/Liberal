...
export function NotificationMenuContentAdmin({ notif }: NotifTypes) {
    const [parent] = useAutoAnimate()
  return (
    <DropdownMenuContent
      align="start"
      sideOffset={8}
      className="w-80 rounded-xl shadow-lg p-3 bg-white border-1 border-solid dark:bg-muted bottom-5"
    >

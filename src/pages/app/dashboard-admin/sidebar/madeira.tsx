       ...
       <div className='flex flex-col relative right-32 gap-3 mt-3 e justify-center items-center'>
          <div className='flex items-center justify-between gap-36'>
                 <Button variant='outline' className='w-80 flex'>
                    <span className='text-orange-600'>Canalizador</span>
                 <ChevronRight className='text-orange-600'/>
                 </Button>
          </div>
           <div className='flex items-center justify-between gap-36'>
                 <Button variant='outline' className='w-80 flex'>
                    <span className='text-orange-600'>Carpinteiro</span>
                 <ChevronRight className='text-orange-600'/>
                 </Button>
          </div>
           <div className='flex items-center justify-between gap-36'>
                 <Button variant='outline' className='w-80 flex'>
                    <span className='text-orange-600'>Serrelheiro & Soldador</span>
                 <ChevronRight className='text-orange-600'/>
                 </Button>
          </div>
        </div>
